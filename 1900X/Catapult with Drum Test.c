...
#pragma config(Motor,  port3,           rCatapult1,    tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port4,           rCatapult2,    tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port5,           rCatapult3,    tmotorVex393_MC29, openLoop, reversed)
...
void runDebugCode() {
	...
	moveCatapultDrumDist(FORWARD, 340);
	...
	//	} else {
			...
			while (1) {
				...
				if (vexRT[Btn7L] && DEBUG_ENABLE) {
					...
					moveCatapultDrumDist(FORWARD,500);
				}
