...
task usercontrol()
{
	if (DEBUG_AUTON) {
  	...
  	//resetDrumPosition();
  	//wait1Msec(2500);
  	//SensorValue[tongue] = 1; //move the tongue in before shooting; it will stay out until the platform is all the way up
		//SensorValue[platformLock] = 0; //release the platform to
