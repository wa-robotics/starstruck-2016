...
task main()
{
	...
	setDrivePower(-127,-127,-127,-127);
	wait1Msec(450);
	//backwards(75, 375); //goes backward to clear cube
	setDrivePower(0,0,0,0);
	wait1Msec(1000);
	strafeRight(127, 200); //strafe right to get to the fence
	wait1Msec(1500);
	//rotate(127, 200, -1); //rotate to get into firing position
	//Rotation
	setDrivePower(-127, 127, 127, -27);
	wait1Msec(1600);
	setCatapultPower(-127);
	wait1Msec(700);
